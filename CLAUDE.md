...
Fresh unmodified NestJS 11 starter (pnpm). No DDD structure exist yet — only stock `src/app.module.ts`, `app.controller.ts`, `app.service.ts`, `main.ts`. DDD architecture build not start.
